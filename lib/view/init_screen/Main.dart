...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Scaffold(bottomNavigationBar: BottomNavigationBar(iconSize: 25,

      selectedIconTheme: IconThemeData(size: 30),
      unselectedLabelStyle: TextStyle(fontSize: 12),
      selectedLabelStyle: TextStyle(fontSize: 16),
      type: BottomNavigationBarType.fixed, onTap:(index) {
        Provider.of<ProductProvider>(context,listen: false).changeIndex(index);
      }
    ...
    ),body: widget.screens[ Provider.of<ProductProvider>(context,listen: true).index ],));
  }
}
